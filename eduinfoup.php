...
<div class="panel-body">Panel Content</div>
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel panel-danger">
     <p></p><div class="panel-body">Panel Content</div>
      <div class="panel-body">Panel Content</div>
      <div class="panel-body">Panel Content</div>
      <div class="panel-body">Panel Content</div>
      <div class="panel-body">Panel Content</div>
...
<p></p> </div></div>
    ...
    <div class="panel panel-default">
      ...
      <textarea placeholder="First name" class="form-control"  rows="1" id="comment" style="max-width: 90% ;margin-left:2% ;margin-right: 2%;margin-bottom: 2%;margin-top: 2%"></textarea>
